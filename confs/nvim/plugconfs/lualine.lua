...
function M.setup()
   ...
   custom_theme.normal.a.bg = 65
   custom_theme.normal.a.fg = 0
   custom_theme.normal.b.bg = 62
   custom_theme.normal.b.fg = 0
   custom_theme.normal.c.bg = 63
   custom_theme.normal.c.fg = 61

   custom_theme.insert.a.bg = 65
   custom_theme.insert.a.fg = 0
   custom_theme.insert.b.bg = 62
   custom_theme.insert.b.fg = 0
   custom_theme.insert.c.bg = 61
   custom_theme.insert.c.fg = 0
